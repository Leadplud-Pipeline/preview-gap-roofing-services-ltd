  ...
  <div className="w-full bg-[#1a1a2e]/80 border border-white/10 rounded-xl p-4 font-sans">
    ...
    <div className="flex items-start justify-between mb-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-white font-semibold text-sm leading-tight">John Niven</p>
    ...
    <p className="text-white/80 text-sm leading-relaxed mb-4">
      We honestly can't thank GAP Roofing Services Ltd enough. We were told by other roofers our roof was beyond repair. From the moment we contacted James, everything changed. Out within 24 hours, repairs done within the same week, to a very high standard. Professional, reliable, and genuinely great to work with from start to finish.
    </p>

    {/* Row 4 — Posted on Google */}
