...
const ServicesHub = () => (
  <Layout>
    <SEO title="Our Roofing Services | GAP Roofing Services Ltd" description="Complete roofing services across the Manchester & Manchester: emergency repairs, replacements, flat roofing, guttering, and more. Free roof inspections." />
