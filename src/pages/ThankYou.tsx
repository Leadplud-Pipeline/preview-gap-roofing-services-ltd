...
const ThankYou = () => {
  ...
  return (
  <Layout>
    <SEO title="Thank You - We'll Be in Touch Shortly | GAP Roofing Services Ltd" description="Thank you for contacting GAP Roofing Services Ltd. We'll review your enquiry and be in touch shortly." robots="noindex, nofollow" />
    <section className="section-light section-padding">
      <div className="container-content text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="tel:+441618500602" className="btn-primary">Call Us Now: +44 161 850 0602</a>
