...
const LocationsHub = () => (
  <Layout>
    <SEO title="GAP Roofing Services Ltd: Serving Cumbria & Manchester" description="We cover the Manchester, Ormskirk, and surrounding areas within a 30-mile radius. Expert roofing services across the North West." />
    <section className="section-dark section-padding">
      <div className="container-content">
        <Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Locations" }]} />
        <h1 className="text-3xl md:text-5xl text-secondary-foreground mb-4">GAP Roofing Services Ltd: Serving Cumbria & Manchester</h1>
        <div className="heading-rule" />
        <p className="text-secondary-foreground/80 font-sans text-lg max-w-2xl leading-relaxed">We cover the Manchester, Ormskirk, and surrounding areas within a 30-mile radius.</p>
      </div>
    </section>
