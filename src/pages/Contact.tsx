...
const Contact = () => {
  ...
  return (
    <Layout>
      <SEO title="Contact GAP Roofing Services Ltd | Free Roofing Estimates" description="Get in touch with GAP Roofing Services Ltd for free roofing estimates. Call +44 161 850 0602 or fill in our contact form." />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4 mb-8">
                <a href="tel:+441618500602" className="flex items-center gap-3 font-sans text-foreground hover:text-primary transition-colors">
                  <Phone size={20} weight="bold" className="text-primary" /> +44 161 850 0602
                </a>
                <a href="mailto:info@preview.vercel.app" className="flex items-center gap-3 font-sans text-foreground hover:text-primary transition-colors">
                  <Envelope size={20} weight="bold" className="text-primary" /> info@preview.vercel.app
                </a>
                <a href="https://www.facebook.com/people/GAP Roofing Services-Roofing-Group/61582355876872/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 font-sans text-foreground hover:text-primary transition-colors">
              ...
              <div className="rounded-lg overflow-hidden border border-border">
                <iframe title="GAP Roofing Services Ltd, Manchester" src="https://maps.google.com/maps?q=Manchester&output=embed" width="100%" height="400" style={{ border: 0, borderRadius: '8px' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
              </div>
            </div>
            <div>
