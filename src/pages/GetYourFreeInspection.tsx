...
const GetYourFreeInspection = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Claim Your Free Roof Inspection | GAP Roofing Services Ltd";
      ...
      <main className="md:hidden flex-1 w-full max-w-xl mx-auto px-4 py-4">
        ...
        <section className="text-center mb-3">
          ...
          <p className="text-xs text-primary font-sans leading-relaxed">
            Join hundreds of Manchester, Manchester, and the Lakes homeowners who have already protected their homes this spring.
          </p>
        </section>
