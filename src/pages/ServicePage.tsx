  ...
  return (
    <Layout>
      ...
      <section className="section-dark section-padding">
        <div className="container-content">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-5xl text-secondary-foreground">{service.name} in the Manchester & Manchester</h1>
          </div>
      ...
      <section className="section-surface section-padding">
        <div className="container-content max-w-3xl">
          <h2 className="text-xl md:text-2xl mb-4">Why Choose GAP Roofing Services Ltd</h2>
          <div className="heading-rule" />
          <ul className="space-y-3">
        ...
        <div className="container-content max-w-3xl">
          ...
          {slug === "emergency-roof-repairs" && (
            <p className="font-sans text-muted-foreground mb-4">
              Based in Manchester or the Manchester and Manchester? See our dedicated{" "}
              <Link to="/services" className="text-primary font-semibold hover:underline">Emergency Roof Repair Manchester page</Link>{" "}
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        provider: { "@type": "HomeAndConstructionBusiness", name: "GAP Roofing Services Ltd", telephone: "+441618500602", address: { "@type": "PostalAddress", streetAddress: "Manchester", addressLocality: "Manchester", postalCode: "FY4 4EF", addressRegion: "Manchester", addressCountry: "GB" } },
        areaServed: "Cumbria and Manchester, North West England", description: service.heroDesc
      })}} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
