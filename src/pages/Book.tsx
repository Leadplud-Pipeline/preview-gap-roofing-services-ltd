...
const Book = () => {
  ...
  return (
    <Layout>
      <SEO title="Book Your Free Roof Inspection & Estimate | GAP Roofing Services Ltd" description="Book a free roof inspection and roofing estimate with GAP Roofing Services Ltd. No obligation, completely free." robots="noindex, nofollow" />
